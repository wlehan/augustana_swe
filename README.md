...
## How The Game Works (6-Golf Card Game)

The objective is to finish with the lowest total score after all rounds.

- Each player has a personal grid of face-down cards (6 cards in a 2x3 layout).
...
- Scores are added at the end of each round, and the game consists of 9 holes (rounds).

Scoring:

- Number cards count as face value (except for 2s, which are worth -2)
- Aces count as 1
- Face cards (Jack and Queen) are worth 10
- Kings are worth 0
- Matching columns may cancel out (e.g. a column of 4s = 0)
